...
public class RoundJTextField extends JTextField {
    ...
    private int curve;
    private Color line_top_gradient;
    private Color line_bottom_gradient;
    private Color color_top_gradient;
    private Color color_bottom_gradient;

    public RoundJTextField() {
        super(30);
        this.curve = 20;
        this.color_bottom_gradient = new Color(167, 207, 215, 255).brighter();
        this.color_top_gradient = new Color(240, 248, 255, 127).brighter();
        this.line_bottom_gradient = new Color(167, 207, 215, 255).brighter();
        this.line_top_gradient = new Color(240, 248, 255, 255).brighter();
        this.icon = null;
